...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dataclass-wizard-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dataclass-wizard-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dataclass-wizard
# for installing globally
pixi global install dataclass-wizard
```
...
It is possible to list all of the versions of `dataclass-wizard` available on your platform:
...
```
pixi search dataclass-wizard --channel conda-forge
```
